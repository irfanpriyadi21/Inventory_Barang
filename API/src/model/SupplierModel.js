...
const storeB = (payload) => { //payload being a parameter that needed to run query, each $1 (parameter) is being represented by the payload respectively
    return pool.query("INSERT INTO inv_supplier(KodeSup, NamaSup, AlamatSup, TelpSup) VALUES($1, $2, $3, $4)", payload)
}
